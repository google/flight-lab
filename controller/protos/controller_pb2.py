...
_COMPONENTSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='badger_status', full_name='flightlab.ComponentStatus.badger_status', index=5,
...
_COMPONENTSTATUS.fields_by_name['badger_status'].enum_type = _BADGER_STATUS
...
_COMPONENTSTATUS.oneofs_by_name['kind'].fields.append(
  _COMPONENTSTATUS.fields_by_name['badger_status'])
_COMPONENTSTATUS.fields_by_name['badger_status'].containing_oneof = _COMPONENTSTATUS.oneofs_by_name['kind']
